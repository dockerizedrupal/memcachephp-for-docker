class memcachephp::httpd {
  ...
  exec { 'mkdir -p /memcachephp/data':
    path => ['/bin']
  }

  exec { 'usermod -d /memcachephp/data www-data':
    path => ['/usr/sbin']
  }
  ...
  file { '/etc/apache2/sites-available/default':
    ...
    source => 'puppet:///modules/memcachephp/etc/apache2/sites-available/default',
    mode => 644
  }
  ...
  file { '/etc/apache2/sites-available/default-ssl':
    ...
    source => 'puppet:///modules/memcachephp/etc/apache2/sites-available/default-ssl',
    mode => 644
  }
  ...
  file { '/etc/apache2/apache2.conf':
    ...
    source => 'puppet:///modules/memcachephp/etc/apache2/apache2.conf',
    mode => 644
  }
}
